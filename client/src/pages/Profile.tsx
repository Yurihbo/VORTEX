...
const COMPANIONS: CompanionOption[] = [
  { id: 'owl', label: 'Coruja Branca', role: 'Mensageira dos Tomos', description: 'Inspirada em corujas mensageiras de plumas alvas, zela pelas suas leituras com sabedoria milenar.', symbol: '🦉', reaction: '"Hoo... uma nova mensagem nas páginas!"', styleClass: 'type-owl', imageUrl: '/manus-storage/companion_owl_cartoon_8e68438d.png' },
  { id: 'dragon', label: 'Dragão Vermelho', role: 'Guardião das Chamas', description: 'Um imponente dragão vermelho de escamas rubis que protege a chama da sua sequência diária.', symbol: '🐉', reaction: '"A chama da leitura arde em brasa!"', styleClass: 'type-dragon', imageUrl: '/manus-storage/companion_dragon_cartoon_ca7ccfc4.png' },
  { id: 'cat', label: 'Gatinha Tricolor', role: 'Musa dos Manuscritos', description: 'Uma charmosa gatinha tricolor de tons laranjas, pretos e brancos que traz aconchego à estante.', symbol: '🐈', reaction: '"Ronrom... hora de abrir um bom livro."', styleClass: 'type-cat', imageUrl: '/manus-storage/companion_cat_cartoon_09ef050f.png' },
  { id: 'fox', label: 'Raposa das Brumas', role: 'Exploradora de Estantes', description: 'Ágil e curiosa, guia você por atalhos secretos entre as coleções da biblioteca.', symbol: '🦊', reaction: '"Encontrei um tomo raro para ti!"', styleClass: 'type-fox', imageUrl: '/manus-storage/companion_fox_cartoon_74680f5c.png' },
  { id: 'griffin', label: 'Grifo Dourado', role: 'Sentinela dos Céus', description: 'Elevado acima das dúvidas, inspira metas ambiciosas e jornadas épicas.', symbol: '🦅', reaction: '"Voemos rumo a novas metas!"', styleClass: 'type-griffin', imageUrl: '/manus-storage/companion_griffin_cartoon_4c533dad.png' },
];
