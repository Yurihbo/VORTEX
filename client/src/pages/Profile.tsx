  ...
  return (
    <details ref={detailsRef} className="profile-collapsible">
      <summary className="profile-collapsible-summary">
        ...
        <ChevronDown className="profile-collapsible-icon" aria-hidden="true" />
      </summary>
      <div className="profile-collapsible-content">{children}</div>
    </details>
  );
}
    ...
    <Layout>
      ...
      <div className="max-w-5xl space-y-7 animate-fade-in">
        ...
        <form onSubmit={saveProfile} className="space-y-6">
          ...
          <ProfileCollapsible eyebrow="Edição do perfil" title="Identidade e constelações">
            <div className="profile-collapsible-grid">
...
<div className="profile-save-action"><Button type="submit" className="wand-click"><Save className="h-4 w-4 mr-2" /> Guardar perfil</Button></div>
        ...
        <ProfileCollapsible eyebrow="Salão das medalhas" title="Marcos da sua jornada">
        ...
        <ProfileCollapsible eyebrow="Cartão de conquistas" title="Leve sua jornada para além da biblioteca">
        ...
        <ProfileCollapsible eyebrow="Guardião simbólico" title="Seu companheiro na biblioteca">
        ...
        <ProfileCollapsible eyebrow="Registro de memórias" title="Suas escolhas em destaque">
        ...
        <ProfileCollapsible eyebrow="Arquivo da biblioteca" title="Guardar ou invocar seus dados">
        ...
        <ProfileCollapsible eyebrow="Privacidade" title="Seus dados, seu reino">
